...
execute if score Waiting PHTForest <= dix number run title @a[scores={Location=3,PHIsInGame=1},tag=PHG.0,tag=finderwaiting] title {"score":{"name":"Waiting","objective":"PHTForest"},"color":"red"}
