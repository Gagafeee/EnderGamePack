...
#finder
execute as @a[scores={Location=3,PHIsInGame=1},tag=PHG.3,tag=finder] run title @s subtitle {"text":"Vous avez trouvé tous les joueurs","color":"green"}
execute as @a[scores={Location=3,PHIsInGame=1},tag=PHG.3,tag=finder] run title @s title {"text":"Win","color":"dark_green"}
