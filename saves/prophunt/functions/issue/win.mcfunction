...
title @a[scores={Location=3},tag=finder] subtitle {"text":"GoodGame \u263a","color":"dark_green"}
title @a[scores={Location=3},tag=finder] title {"text":"You found theme all !","color":"green"}
